...
<html lang="en">
    ...
    <body>
        ...
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-light col-lg-5" style="width: 280px;">
            ...
            <li>
                <a href="./input-berita.php" class="nav-link link-dark">
                    <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#speedometer2"></use></svg>
                    Input Berita
                </a>
            </li>
            <li>
                <a href="./input-galery.php" class="nav-link active">
                    <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#speedometer2"></use></svg>
                    Input Galery
                </a>
            </li>
            <li>
                <a href="./input-jadwal.php" class="nav-link link-dark" aria-current="page">
                    <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#table"></use></svg>
                    Input Jadwal
                </a>
            </li>
            <li>
                <a href="./input-user.php" class="nav-link link-dark">
                    <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#speedometer2"></use></svg>
                    Input User
                </a>
            </li>
