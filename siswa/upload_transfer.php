<?php
    ...
    $siswa = mysqli_query(Koneksi::getKoneksi(),$qsiswa);
...
<html lang="en">
    ...
    <body>
        ...
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-light col-lg-5" style="width: 280px;">
            ...
            <li>
                <a href="./nilai.php" class="nav-link link-dark">
        ...
        <div class="container mt-5">
            <form action="./redirect.php" method="post">
                <div class="mb-3 row">
                    <label for="jumlah" class="col-sm-2 col-form-label">Nilai</label>
                    <div class="col-sm-10">
                        <input class="form-control" placeholder="Jumlah" type="number" id="jumlah" name="jumlah" required>
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="tanggal" class="col-sm-2 col-form-label">Nilai</label>
                    <div class="col-sm-10">
                        <input class="form-control" placeholder="Tanggal" type="date" id="tanggal" name="tanggal" required>
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="myfile" class="col-sm-2 col-form-label">Nilai</label>
                    <div class="col-sm-10">
                ...
                <button class = "btn btn-danger mt-2" onclick="location.href='./keuangan.php'">
                    Back
                </button>
        </div>
        </div>
